...
Windows 32-bit
   ImageMagick-6.9.1-2-Q16-x86-dll.exe__

Windows 64-bit
   ImageMagick-6.9.1-2-Q16-x64-dll.exe__
...
of ImageMagick (e.g. :file:`C:\\Program Files\\ImageMagick-6.9.1-Q16`).
You can set it in :menuselection:`Computer --> Properties -->
Advanced system settings --> Advanced --> Enviro&nment Variables...`.

__ http://www.imagemagick.org/download/binaries/ImageMagick-6.9.1-2-Q16-x86-dll.exe
__ http://www.imagemagick.org/download/binaries/ImageMagick-6.9.1-2-Q16-x64-dll.exe
